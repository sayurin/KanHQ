...
static FARPROC proc(const char* name) {
	...
	if (!dll) {
		...
		PathAppend(path, TEXT("WININET.dll"));
...
static void proc(Func& func, const char* name) {
	if (!func)
...
INTERNETAPI_(HINTERNET) HttpOpenRequestA(_In_ HINTERNET hConnect, _In_opt_ LPCSTR lpszVerb, _In_opt_ LPCSTR lpszObjectName, _In_opt_ LPCSTR lpszVersion, _In_opt_ LPCSTR lpszReferrer, _In_opt_z_ LPCSTR FAR * lplpszAcceptTypes, _In_ DWORD dwFlags, _In_opt_ DWORD_PTR dwContext) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&HttpOpenRequestA) func = nullptr;
	proc(func, __FUNCTION__);

	_RPTWN(_CRT_WARN, L"WININET: HttpOpenRequestA(%S %S)\n", lpszVerb, lpszObjectName);
	auto file = func(hConnect, lpszVerb, lpszObjectName, lpszVersion, lpszReferrer, lplpszAcceptTypes, dwFlags, dwContext);
	auto lastError = GetLastError();
...
INTERNETAPI_(HINTERNET) HttpOpenRequestW(_In_ HINTERNET hConnect, _In_opt_ LPCWSTR lpszVerb, _In_opt_ LPCWSTR lpszObjectName, _In_opt_ LPCWSTR lpszVersion, _In_opt_ LPCWSTR lpszReferrer, _In_opt_z_ LPCWSTR FAR * lplpszAcceptTypes, _In_ DWORD dwFlags, _In_opt_ DWORD_PTR dwContext) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&HttpOpenRequestW) func = nullptr;
	proc(func, __FUNCTION__);
...
BOOLAPI HttpSendRequestA(_In_ HINTERNET hRequest, _In_reads_opt_(dwHeadersLength) LPCSTR lpszHeaders, _In_ DWORD dwHeadersLength, _In_reads_bytes_opt_(dwOptionalLength) LPVOID lpOptional, _In_ DWORD dwOptionalLength) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&HttpSendRequestA) func = nullptr;
	proc(func, __FUNCTION__);

	_RPTWN(_CRT_WARN, L"WININET: HttpSendRequestA(opt=%d)\n", dwOptionalLength);
	auto result = func(hRequest, lpszHeaders, dwHeadersLength, lpOptional, dwOptionalLength);
...
BOOLAPI HttpSendRequestW(_In_ HINTERNET hRequest, _In_reads_opt_(dwHeadersLength) LPCWSTR lpszHeaders, _In_ DWORD dwHeadersLength, _In_reads_bytes_opt_(dwOptionalLength) LPVOID lpOptional, _In_ DWORD dwOptionalLength) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&HttpSendRequestW) func = nullptr;
	proc(func, __FUNCTION__);
...
BOOLAPI InternetReadFile(_In_ HINTERNET hFile, _Out_writes_bytes_(dwNumberOfBytesToRead) __out_data_source(NETWORK) LPVOID lpBuffer, _In_ DWORD dwNumberOfBytesToRead, _Out_ LPDWORD lpdwNumberOfBytesRead) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&InternetReadFile) func = nullptr;
	proc(func, __FUNCTION__);

	auto result = func(hFile, lpBuffer, dwNumberOfBytesToRead, lpdwNumberOfBytesRead);
	auto lastError = GetLastError();
	{
		std::lock_guard<std::mutex> lock(mutex);
...
BOOLAPI InternetQueryDataAvailable(_In_ HINTERNET hFile, _Out_opt_ __out_data_source(NETWORK) LPDWORD lpdwNumberOfBytesAvailable, _In_ DWORD dwFlags, _In_opt_ DWORD_PTR dwContext) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&InternetQueryDataAvailable) func = nullptr;
	proc(func, __FUNCTION__);

	auto result = func(hFile, lpdwNumberOfBytesAvailable, dwFlags, dwContext);
	auto lastError = GetLastError();
...
BOOLAPI InternetCloseHandle(_In_ HINTERNET hInternet) {
	__pragma(comment(linker, "/EXPORT:" __FUNCTION__ "=" __FUNCDNAME__));
	static decltype(&InternetCloseHandle) func = nullptr;
	proc(func, __FUNCTION__);
...
#pragma region "proxy"
#define FUNCTION(EXPORT, PROCNAME, RESULT, NAME, PARAMETERS, ARGUMENTS) RESULT NAME PARAMETERS {	\
	__pragma(comment(linker, "/EXPORT:" EXPORT));													\
	_RPTWN(_CRT_WARN, L"WININET: function called: %S\n", __FUNCTION__);								\
	static decltype(&NAME) func = nullptr;															\
	proc(func, PROCNAME);																			\
	return func ARGUMENTS;																			\
}
#define FUNCTION_UNKNOWN(EXPORT, RESULT, NAME, PARAMETERS, ARGUMENTS) INTERNETAPI_(void) NAME () {	\
	__pragma(comment(linker, "/EXPORT:" EXPORT));													\
	_RPTWN(_CRT_ERROR, L"WININET: unknown function called: %S\n", __FUNCTION__);					\
}
#define FUNCTION_NAME(           RESULT, NAME, PARAMETERS, ARGUMENTS) FUNCTION(__FUNCTION__ "=" __FUNCDNAME__,        __FUNCTION__,              RESULT, NAME, PARAMETERS, ARGUMENTS)
#define FUNCTION_NONAME(ORDINAL, RESULT, NAME, PARAMETERS, ARGUMENTS) FUNCTION(__FUNCDNAME__ ",@" #ORDINAL ",NONAME", MAKEINTRESOURCEA(ORDINAL), RESULT, NAME, PARAMETERS, ARGUMENTS)
#define FUNCTION_UNKNOWN_NAME(           RESULT, NAME, PARAMETERS, ARGUMENTS) FUNCTION_UNKNOWN(__FUNCTION__ "=" __FUNCDNAME__,        RESULT, NAME, PARAMETERS, ARGUMENTS)
#define FUNCTION_UNKNOWN_NONAME(ORDINAL, RESULT, NAME, PARAMETERS, ARGUMENTS) FUNCTION_UNKNOWN(__FUNCDNAME__ ",@" #ORDINAL ",NONAME", RESULT, NAME, PARAMETERS, ARGUMENTS)
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(void), AppCacheCreateAndCommitFile, (), ())
...
FUNCTION_NAME(void CALLBACK, DispatchAPICall, (HWND hwnd, HINSTANCE hinst, LPSTR lpszCmdLine, int nCmdShow), (hwnd, hinst, lpszCmdLine, nCmdShow))
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), ForceNexusLookup, (), ())
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), ForceNexusLookupExW, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), GetProxyDllInfo, (), ())
...
FUNCTION_NAME(BOOLAPI, GopherGetAttributeA, (_In_ HINTERNET hConnect, _In_ LPCSTR lpszLocator, _In_opt_ LPCSTR lpszAttributeName, _At_((LPSTR)lpBuffer, _Out_writes_(dwBufferLength)) LPBYTE lpBuffer, _In_ DWORD dwBufferLength, _Out_ LPDWORD lpdwCharactersReturned, _In_opt_ GOPHER_ATTRIBUTE_ENUMERATOR lpfnEnumerator, _In_opt_ DWORD_PTR dwContext), (hConnect, lpszLocator, lpszAttributeName, lpBuffer, dwBufferLength, lpdwCharactersReturned, lpfnEnumerator, dwContext))
...
FUNCTION_NAME(BOOLAPI, HttpAddRequestHeadersA, (_In_ HINTERNET hRequest, _When_(dwHeadersLength == (DWORD)-1, _In_z_) _When_(dwHeadersLength != (DWORD)-1, _In_reads_(dwHeadersLength)) LPCSTR lpszHeaders, _In_ DWORD dwHeadersLength, _In_ DWORD dwModifiers), (hRequest, lpszHeaders, dwHeadersLength, dwModifiers))
FUNCTION_NAME(BOOLAPI, HttpAddRequestHeadersW, (_In_ HINTERNET hRequest, _When_(dwHeadersLength == (DWORD)-1, _In_z_) _When_(dwHeadersLength != (DWORD)-1, _In_reads_(dwHeadersLength)) LPCWSTR lpszHeaders, _In_ DWORD dwHeadersLength, _In_ DWORD dwModifiers), (hRequest, lpszHeaders, dwHeadersLength, dwModifiers))
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), HttpIsHostHstsEnabled, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), InternetAutodialCallback, (), ())
...
FUNCTION_NAME(BOOLAPI, InternetClearAllPerSiteCookieDecisions, (), ())
//InternetCloseHandle
...
FUNCTION_NAME(BOOLAPI, LoadUrlCacheContent, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(void), ShowCertificate, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), UrlCacheFreeGlobalSpace, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), UrlCacheGetGlobalCacheSize, (), ())
...
FUNCTION_NAME(URLCACHEAPI, UrlCacheReloadSettings, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), UrlCacheServer, (), ())
...
FUNCTION_UNKNOWN_NAME(INTERNETAPI_(DWORD), UrlZonesDetach, (), ())
...
FUNCTION_UNKNOWN_NONAME(112, INTERNETAPI_(int), CHttp2Stream_ConnLimitExempted, (), ())
...
FUNCTION_UNKNOWN_NONAME(120, INTERNETAPI_(void), MapResourceToPolicy, (), ())
FUNCTION_UNKNOWN_NONAME(121, INTERNETAPI_(void), GetP3PPolicy, (), ())
FUNCTION_UNKNOWN_NONAME(122, INTERNETAPI_(void), FreeP3PObject, (), ())
FUNCTION_UNKNOWN_NONAME(123, INTERNETAPI_(void), GetP3PRequestStatus, (), ())
...
FUNCTION_UNKNOWN_NONAME(402, INTERNETAPI_(DWORD), InternetAutoProxyGetProxyForUrl, (), ())
FUNCTION_UNKNOWN_NONAME(403, INTERNETAPI_(DWORD), InternetAutoProxyOnSendRequestComplete, (), ())
FUNCTION_UNKNOWN_NONAME(410, INTERNETAPI_(DWORD), GetCacheServerConnection, (), ())
FUNCTION_UNKNOWN_NONAME(411, INTERNETAPI_(DWORD), CreateCacheServerRpcBinding, (), ())
FUNCTION_UNKNOWN_NONAME(413, INTERNETAPI_(DWORD), SetGlobalJetParameters, (), ())
FUNCTION_UNKNOWN_NONAME(420, INTERNETAPI_(DWORD), IsLanConnection, (), ())
FUNCTION_UNKNOWN_NONAME(421, INTERNETAPI_(DWORD), IsDialUpConnection, (), ())
FUNCTION_UNKNOWN_NONAME(422, INTERNETAPI_(DWORD), RegisterForNetworkChangeNotification, (), ())
FUNCTION_UNKNOWN_NONAME(423, INTERNETAPI_(DWORD), UnRegisterNetworkChangeNotification, (), ())
#pragma endregion
